...
export interface Conditions {
	...
	"md": string
	/** `@media screen and (min-width: 64rem) and (max-width: 81.9975rem)` */
	"mdOnly": string
	...
	/** `@media screen and (min-width: 82rem)` */
	"lgOnly": string
	/** `@media screen and (max-width: 81.9975rem)` */
	"lgDown": string
	/** `@media screen and (min-width: 48rem) and (max-width: 63.9975rem)` */
	"smToMd": string
	/** `@media screen and (min-width: 48rem) and (max-width: 81.9975rem)` */
	"smToLg": string
	/** `@media screen and (min-width: 64rem) and (max-width: 81.9975rem)` */
	"mdToLg": string
