...
impl Kitoken {
    ...
    #[staticmethod]
    pub fn from_file(path: &str) -> PyResult<Kitoken> {
        Ok(Kitoken {
            inner: Inner::from_file(path).map_err(|e| PyValueError::new_err(format!("{:?}", e)))?,
        })
    }
    ...
    #[staticmethod]
    pub fn from_sentencepiece_file(path: &str) -> PyResult<Kitoken> {
        Ok(Kitoken {
            inner: Inner::from_sentencepiece_file(path)
                .map_err(|e| PyValueError::new_err(format!("{:?}", e)))?,
        })
    }
    ...
    #[staticmethod]
    pub fn from_tiktoken_file(path: &str) -> PyResult<Kitoken> {
        Ok(Kitoken {
            inner: Inner::from_tiktoken_file(path)
                .map_err(|e| PyValueError::new_err(format!("{:?}", e)))?,
        })
    }
}
